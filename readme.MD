...
* Now get your HTTPS repo-url copied for cloning
* clone your repo
...
│       └── cloned-repo-url       # Your cloned repo for development
└── ...
```
...
Then add the corresponding closing GTM script below the closing `</body>` tag.
...
5. This is shared and identical on all implementations, and does not require any tweaking.
